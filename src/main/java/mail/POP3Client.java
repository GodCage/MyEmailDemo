...
public class POP3Client {
    ...
    public static void main(String[] args) throws UnknownHostException, IOException {
        ...
        String user="kage_wang@163.com";//用户名，填写自己的邮箱用户名
        //[b62aaa251425b4be4eaec4ab4744cf47s]
        String password="864676212wkq";//密码，填写自己的密码
        
//       String user="864676212@qq.com";//用户名，填写自己的邮箱用户名
//        
//        String password="864676212WKQ";//密码，填写自己的密码
 ...
 //retr命令
    public void retr(int mailNum,BufferedReader in,BufferedWriter out) throws IOException, InterruptedException{
            ...
            String messagedetail = getMessagedetail(in);
          
            final BASE64Decoder decoder = new BASE64Decoder();
    		byte[] decodeBuffer = decoder.decodeBuffer(messagedetail);
    		String qw = new String(decodeBuffer, "gb2312");
